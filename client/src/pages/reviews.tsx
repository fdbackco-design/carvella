...
export default function Reviews() {
  ...
  return (
    <div className="py-20 bg-background font-sans" data-testid="page-reviews">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Rating Summary */}
        <Card
          className="bg-card rounded-lg p-8 mb-12 text-center font-sans"
          data-testid="card-rating-summary"
        >
          <CardContent className="p-0">
            <div className="flex items-center justify-center mb-4">
              <div
                className="text-6xl font-bold text-primary mr-4"
              ...
              <div>
                <div
                  className="flex text-accent text-2xl mb-2"
                  data-testid="stars-average-rating"
                >
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12 font-sans">
            {reviews.map((review) => (
              <ReviewCard
                key={review.id}
                name={review.name}
