              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6" data-testid="form-review">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-sm font-medium">평점 *</FormLabel>
                        <Select 
                          onValueChange={(value) => field.onChange(parseInt(value))} 
                          value={field.value?.toString() || ""}
                        >
                          <FormControl>
                            <SelectTrigger className="touch-target-comfortable" data-testid="select-rating">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-sm font-medium">후기 내용 *</FormLabel>
                      <FormControl>
                        <Textarea
