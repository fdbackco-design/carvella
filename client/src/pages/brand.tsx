...
export default function Brand() {
  ...
  return (
    <div className="py-20 bg-background font-sans" data-testid="page-brand">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            <h3
              className="text-3xl font-sans font-semibold mb-6"
              data-testid="text-brand-beginning-title"
            >
              전통의 시작
            </h3>
            <p
              className="text-lg text-muted-foreground mb-6"
              data-testid="text-brand-beginning-p1"
            >
              1890년, 토스카나의 작은 마을에서 시작된 카르벨라의 여정은 Giuseppe
              Carbella의 작은 대장간에서 시작되었습니다. 그의 정교한 손길로
              탄생한 첫 번째 나이프는 지역 요리사들 사이에서 빠르게 명성을
              얻었습니다.
            </p>
            <p
              className="text-lg text-muted-foreground"
              data-testid="text-brand-beginning-p2"
            >
              오늘날까지도 우리는 Giuseppe의 철학을 이어받아 '완벽함은 디테일에
              있다'는 믿음으로 각각의 제품을 만들고 있습니다.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          {values.map((value, index) => {
            ...
            return (
              <Card
                key={index}
                className="text-center bg-card p-8 font-sans"
              ...
              >
                <CardContent className="p-0">
                  ...
                  <h4
                    className="text-2xl font-sans font-semibold mb-4"
        ...
        <div className="bg-card rounded-lg p-12 text-center font-sans">
          <h3
            className="text-3xl font-sans font-semibold mb-6"
          ...
          >
            카르벨라는 단순히 주방용품을 만드는 것이 아닙니다. 우리는 요리하는
            모든 순간을 특별하게 만드는 도구를 창조합니다. 각각의 나이프는 수백
            번의 단조를 거쳐 완성되며, 모든 도마는 자연이 수십 년간 키워낸
            나무에서 탄생합니다.
          </p>
          <p
